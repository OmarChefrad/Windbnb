...
const Header = () => {
  return (
    <header className="sticky top-0 z-50 grid grid-cols-2  md:grid-cols-3  bg-white shadow pt-4 py-4 md:-px-10">
      ...
      <div className="flex space-x-4 items-center justify-end text-gray-600 md:pr-10 pr-0">
